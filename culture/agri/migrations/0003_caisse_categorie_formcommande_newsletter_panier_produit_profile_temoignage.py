    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_upd', models.DateTimeField(auto_now=True)),
                ('statut', models.BooleanField()),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserPanier', to=settings.AUTH_USER_MODEL)),
                ('produit', models.ManyToManyField(to='agri.Produit')),
            ],
        ),
    ]
